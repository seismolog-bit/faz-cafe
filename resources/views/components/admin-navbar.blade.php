...
<nav class="navbar navbar-top navbar-slim navbar-expand" id="navbarSlim" style="display:none;">
    <div class="collapse navbar-collapse justify-content-between">
        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
                                ...
                                <div class="border-300">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m status-online me-3"><img
                                                        class="rounded-circle" src="../../assets/img/team/57.png"
                                                        alt="" /></div>
                                                <div class="me-3 flex-1">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" id="navbarDropdownNindeDots" href="#" role="button" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false"><svg width="10" height="10" viewbox="0 0 16 16"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="2" cy="2" r="2" fill="currentColor"></circle>
                        <circle cx="2" cy="8" r="2" fill="currentColor"></circle>
                        <circle cx="2" cy="14" r="2" fill="currentColor"></circle>
                            ...
                            <div class="row gx-0">
                                <div class="col-6">
                                    <div class="nav flex-column"><a class="nav-link fw-semi-bold"
                                            href="../starter.html">Starter</a><a class="nav-link fw-semi-bold"
                                            href="faq.html">Faq</a>
                                        <p class="nav-link mb-0 fw-bold">Pricing</p><a class="nav-link fw-semi-bold"
                                            href="pricing/pricing-column.html">Pricing column</a><a
                                            class="nav-link fw-semi-bold" href="pricing/pricing-grid.html">Pricing
                                            grid</a><a class="nav-link fw-semi-bold"
                                            href="notifications.html">Notifications</a><a class="nav-link fw-semi-bold"
                                            href="members.html">Members</a>
                                ...
                                <div class="col-6">
                                    <div class="nav flex-column">
                                        <p class="nav-link mb-0 fw-bold">Errors</p><a class="nav-link fw-semi-bold"
                                            href="../errors/404.html">404</a><a class="nav-link fw-semi-bold"
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#" role="button"
                ...
                <div class="dropdown-menu navbar-dropdown-caret py-0" aria-labelledby="documentations">
                    <div class="dropdown-menu-content py-2"><a class="dropdown-item fw-semi-bold"
                            ...
                            href="../../documentation/gulp.html">Gulp</a><a class="dropdown-item fw-semi-bold"
                    ...
                    <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                        <div class="row text-center align-items-center gx-0 gy-0">
                            <div class="col-4">
                                <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                    href="#!">
                                    <img src="../../assets/img/nav-icons/behance.png" alt="" width="30" />
                                    <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">Behance</p>
                                </a>
                            </div>
                            <div class="col-4"><a
...
<nav class="navbar navbar-top navbar-slim justify-content-between navbar-expand-lg" id="navbarTopSlimNew"
    ...
    <ul class="navbar-nav navbar-nav-icons flex-row">
                        ...
                        <div class="row text-center align-items-center gx-0 gy-0">
                            <div class="col-4">
                                <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                    href="#!">
                                    {{-- <img src="../../assets/img/nav-icons/behance.png" alt="" width="30" /> --}}
                                    <i class="fa-regular fa-cart-shopping" style="width: 30px"></i>
                                    <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">Transaksi Aktif</p>
                                </a>
                            </div>
                            <div class="col-4">
                                <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                    href="#!">
                                    <i class="fa-regular fa-cart-plus" style="width: 30px"></i>
                                    <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">Transaksi Aktif</p>
                                </a>
                            </div>
                            <div class="col-4"><a
        ...
        <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Olivia
