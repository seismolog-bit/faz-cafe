    ...
    <div class="row g-5">
        <div class="col-12 col-md-8 mb-4">
            <div class="mb-4">
                ...
                <input class="form-control datetimepicker" id="datepicker" type="text" placeholder="dd/mm/yyyy" name="reservation_date" value="{{ Carbon\Carbon::createFromFormat('Y-m-d', $reservation->reservation_date)->format('d-m-Y') }}" data-options='{"disableMobile":false,"dateFormat":"d/m/Y"}' required />
            </div>
            <div class="row g-5">
                <div class="col-12 col-sm-6">
                    <div class="mb-4">
                        <label class="text-1000 form-label">Jam Mulai</label>
                        <input class="form-control datetimepicker" id="timepicker1" name="start_time" type="text" placeholder="Jam : Menit" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":false, "time_24hr": true}' value="{{ $reservation->start_time }}" required />
                    </div>
                </div>
                <div class="col-12 col-sm-6">
                    <div class="mb-4">
                        <label class="text-1000 form-label">Jam Selesai</label>
                        <input class="form-control datetimepicker" id="timepicker2" name="end_time" type="text" placeholder="Jam : Menit" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":false, "time_24hr": true}' value="{{ $reservation->end_time }}" required />
                    </div>
                </div>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input class="form-control" type="text" placeholder="Pembeli" required name="buyer" value="{{ $reservation->buyer }}"/>
            </div>
            <div class="mb-4">
                <label class="text-1000 form-label">DP</label>
                <input class="form-control" type="number" placeholder="Down Payment" required name="down_payment" value="{{ $reservation->down_payment }}"/>
            </div>
