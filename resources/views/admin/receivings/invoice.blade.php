...
<head>
    ...
    <!-- Site Title -->
    <title>Invoice Belanja Barang</title>
            ...
            <div class="tm_invoice tm_style1 tm_radius_0" id="tm_download_section">
                <div class="tm_invoice_in">
                    <div class="tm_flex tm_flex_column_sm tm_justify_between tm_align_center tm_align_start_sm tm_f14 tm_primary_color tm_medium tm_mb5">
                        <p class="tm_m0 tm_f18 tm_bold">Invoice Belanja Barang</p>
                        <p class="tm_m0">Tanggal: {{ $receiving->created_at->format('d-m-Y H:i') }}</p>
                        <p class="tm_m0">No Invoice: BB-{{ $receiving->id }}</p>
                    </div>
                    ...
                    <div class="tm_invoice_head tm_mb10">
                        <div class="tm_invoice_left">
                            <p class="tm_mb2"><b class="tm_primary_color">Warung/Toko:</b></p>
                            <p>
                                {{ $receiving->place }}
                            </p>
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="tm_width_2 tm_semi_bold tm_primary_color tm_border_left">Harga</th>
                                    ...
                                    <tbody>
                                        @foreach ($receiving->receiving_items as $item)
                                        <tr>
                                            <td class="tm_width_3">{{ $item->item->name }}</td>
                                            <td class="tm_width_2 tm_border_left">{{ number_format($item->price) }}</td>
                                            <td class="tm_width_1 tm_border_left">{{ $item->qty }}</td>
                                            <td class="tm_width_2 tm_border_left tm_text_right">{{ number_format($item->total) }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    <p class="tm_mb20">{{ $receiving->note }}</p>
